# <a name="office-add-in-that-uses-the-auth0-service-to-simplify-social-login"></a>Использование службы Auth0 в надстройках Office для упрощения входа через социальные сети
...
2. На вкладке **Вставка** в Word 2016 выберите **Мои надстройки**. (Кнопка может находиться на вкладке **Разработчик** вместо вкладки **Вставка**. Чтобы отобразить вкладку **Разработчик**, следуйте [этим инструкциям](https://support.office.com/ru-ru/article/Show-the-Developer-tab-E1192344-5E56-4D45-931B-E5FD9BEA2D45)).
